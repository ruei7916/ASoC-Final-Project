...
int main() {
  ...
  userdma(inStream_t, &s2m_buf_sts, s2m_sts_clear, S2M_LEN, s2m_en_clrsts, out_b, &s2m_err, imgwidth, in_b, &m2s_buf_sts, m2s_sts_clear, M2S_LEN, m2s_en_clrsts, outStream_t, endianness);
